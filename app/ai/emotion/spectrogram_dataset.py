...
class EmotionSpectrogramDataset(Dataset):
    ...
    def _compute_log_mel(self, waveform: torch.Tensor) -> torch.Tensor:
        ...
        log_mel_tensor = torch.tensor(log_mel, dtype=torch.float32).unsqueeze(0)  # [1, n_mels, time]
    ...
    def __getitem__(self, idx: int):
        ...
        features = self._compute_log_mel(waveform)

        return {
            "features": features,  # [1, n_mels, time]
